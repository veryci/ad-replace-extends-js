...
const pcreplaceArr = [{ // PC端替换的广告
  src: 'https://se.jmf47.cn/dia_ti_ne.js?slid=2E44817D030C19282573C3DA26628B0E&w=300&h=250',
  size: '300:250',
  ceil: 100,
  status: 0,
}];
const adreplaceArr = [{ // 移动端替换的广告
  src: 'https://se.jmf47.cn/dia_ti_ne.js?slid=1D7DED3D480D4CF3CDDF135FA596601B&w=640&h=100',
  ratio: 100 / 640,
  ceil: 1,
  status: 0,
}];
