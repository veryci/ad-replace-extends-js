const adArr = [{
  append: "var dxx_uid ='684216FA682B79FFD73797973533777B';var slot_dxx_w=640;var slot_dxx_h=100;",
  className: 'dxx_agsc',
  src: 'https://vsx.vsx3e.cn/dia_dx.js',
}];
const pcArr = [{
  append: "var dxx_uid ='B48A60A2BF088607E129A322A4248BD6';var slot_dxx_w=300;var slot_dxx_h=250;",
  className: 'dxx_agsc',
  src: 'https://vsx.vsx3e.cn/dia_dx.js',
}];
