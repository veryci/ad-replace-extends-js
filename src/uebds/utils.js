const adArr = [{
  append: "var dxx_uid ='F07EF5444C3972B13993483DBA0F0C8F';var slot_dxx_w=640;var slot_dxx_h=100;",
  className: 'dxx_agsc',
  src: 'https://vsx.vsx3e.cn/dia_dx.js',
}];
const pcArr = [{
  append: "var dxx_uid ='053026DC47B9658783E09B99F3AC798E';var slot_dxx_w=300;var slot_dxx_h=250;",
  className: 'dxx_agsc',
  src: 'https://vsx.vsx3e.cn/dia_dx.js',
}];
